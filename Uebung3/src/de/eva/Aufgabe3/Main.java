...
public class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    String fileName = "out/production/Uebung3/de/eva/Aufgabe3/resources/mails.txt";
    BufferedReader br =
    ...
    MailUniLeipzig le =
      (MailUniLeipzig) EmailAddressFactory.createEmail("dfh", "uni-leipzig", "de");
    MailUniEngland en =
      (MailUniEngland) EmailAddressFactory.createEmail("dfh", "uni-england", "en");
